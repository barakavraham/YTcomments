...
while(True):
    for comment in comments["items"]:
        ...
        if author_comment["authorDisplayName"] == AUTHOR_NAME:
            all_comments.append(f'{author_comment["authorDisplayName"]}: \n\n{author_comment["textDisplay"]}')
        if comment["snippet"]["totalReplyCount"] != 0:
            ...
            for reply in replies["items"]:
                ...
                if reply["snippet"]["authorDisplayName"] == AUTHOR_NAME:
                    all_comments.append(f'{reply["snippet"]["authorDisplayName"]}: \n\n{reply["snippet"]["textDisplay"]}')
    print(f'{comments_counter} comments as been checked...')
    try:
